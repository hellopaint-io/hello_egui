...
///
/// Call this once at startup. Rendering a child off-screen - which is what
/// [`crate::Regui::offscreen`] and [`crate::Regui::retain`] do - needs the device and the
/// target format, and there is no way to reach them from inside a widget.
///
/// ```no_run
